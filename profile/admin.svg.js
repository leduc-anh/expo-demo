...
export default function AdminProfileIcon({ size = 20 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      ...
      <G clipPath="url(#clip)">
        {/* Body */}
        <Path
          d="M12.418 19.129C12.352 19.09 12.281 19.051 12.215 19.012L11.805 19.188C11 19.531 10.066 19.219 9.629 18.461L8.926 17.242C8.488 16.484 8.688 15.52 9.387 14.992L9.742 14.727V14.609V14.492L9.387 14.227C8.688 13.699 8.492 12.734 8.926 11.977L9.629 10.758C9.84 10.395 10.172 10.121 10.566 9.988C9.594 9.543 8.535 9.313 7.465 9.316C3.344 9.313 0 12.656 0 16.777V18.941C0 19.527 0.473 20 1.059 20H12.578C12.523 19.863 12.488 19.719 12.469 19.57L12.418 19.129Z"
          fill="url(#grad)"
        />
